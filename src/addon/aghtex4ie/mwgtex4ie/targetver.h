...
#ifndef WINVER                  // 最低限必要なプラットフォームが Windows Vista 0x0600 であることを指定します。
#define WINVER 0x0501           // WinXP
#endif

#ifndef _WIN32_WINNT            // 最低限必要なプラットフォームが Windows Vista 0x0600 であることを指定します。
...
#ifndef _WIN32_IE               // 最低限必要なプラットフォームが Internet Explorer 7.0 0x0700 であることを指定します。
